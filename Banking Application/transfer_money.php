...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto fs-5">
          ...
          <li class="nav-item active">
            <a class="nav-link active" href="transfer_money.php"
              style="color: rgb(4, 142, 247); font-weight: 700">Transfer Money</a>
          </li>
          <li class="nav-item">
  ...
  <section id="all-user">
    <div class="container">
      <div class="m-auto my-2 tm-box d-flex justify-content-center">
        <div class="rectangle">
          <h3 class="text-uppercase text-cu my-3 text-center">
            transfer money
          </h3>
          <div class="container table-responsive">
            <table class="table table-blue table-hover my-3">
              <thead>
                <tr>
                  <th scope="col">#</th>
              ...
              <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  <td scope='row'><a href='transaction.php'><button class='button btn-transfer' type='submit'>
                        Transfer Money
                      </button></a></td>
                </tr>
                  ";
